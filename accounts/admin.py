...
from accounts.models import FirebaseToken, ExternalNotification, Attribution, AppTrackerCode
...
@admin.register(AppTrackerCode)
class AppTrackerCodeAdmin(admin.ModelAdmin):
