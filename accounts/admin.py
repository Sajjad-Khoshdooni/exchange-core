...
class CustomUserAdmin(ModelAdminJalaliMixin, SimpleHistoryAdmin, AdvancedAdmin, UserAdmin):
    ...
    fields_edit_conditions = {
        ...
        'first_name': True,
        'last_name': True,
        'is_staff': M.has_perm('manage_users'),
        'national_code': M.has_perm('manage_users') | ~M('national_code_verified'),
        'national_code_phone_verified': True,
        'birth_date': M.has_perm('manage_users') | ~M('birth_date_verified'),
        'selfie_image_verified': M.has_perm('manage_users') | M('selfie_image'),
        'selfie_image_discard_text': M.has_perm('manage_users') | (M('selfie_image') & M.is_none('selfie_image_verified')),
        'first_name_verified': M.has_perm('manage_users') | M.is_none('first_name_verified'),
        'last_name_verified': M.has_perm('manage_users') | M.is_none('last_name_verified'),
        'national_code_verified': M.has_perm('manage_users') | ~M('national_code_verified'),
        'birth_date_verified': M.has_perm('manage_users') | M.is_none('birth_date_verified'),
        'can_withdraw': True,
        'can_withdraw_crypto': True,
        'can_trade': True,
        'withdraw_limit_whitelist': M.has_perm('manage_users'),
        'withdraw_risk_level_multiplier': M.has_perm('manage_users'),
    }
