# Generated by Django 4.0 on 2022-03-06 09:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(blank=True, null=True, verbose_name='تاپیدیه تاریخ تولد'),
        ),
        migrations.AlterField(
            model_name='user',
            name='email_verified',
            field=models.BooleanField(default=False, verbose_name='تاپیدیه ایمیل'),
        ),
        migrations.AlterField(
            model_name='user',
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(blank=True, null=True, verbose_name='تاپیدیه نام'),
        ),
        migrations.AlterField(
            model_name='user',
            name='last_name_verified',
            field=models.BooleanField(blank=True, null=True, verbose_name='تاپیدیه نام خانوادگی'),
        ),
        migrations.AlterField(
            model_name='user',
            name='level',
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(blank=True, null=True, verbose_name='تاپیدیه کد ملی'),
        ),
        migrations.AlterField(
            model_name='user',
            name='phone',
