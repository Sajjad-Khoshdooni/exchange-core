...
class VerificationCode(models.Model):
    ...
    SCOPE_CHANGE_PHONE_V1 = 'change_phone_v1'
    SCOPE_2FA = '2fa'
    ...
    SCOPE_CHOICES = [
        ...
        (SCOPE_CHANGE_PHONE_V1, SCOPE_CHANGE_PHONE_V1), (SCOPE_VERIFY_EMAIL, SCOPE_VERIFY_EMAIL),
        (SCOPE_FIAT_WITHDRAW, SCOPE_FIAT_WITHDRAW), (SCOPE_2FA, SCOPE_2FA), (SCOPE_API_TOKEN, SCOPE_API_TOKEN),
        (SCOPE_ADDRESS_BOOK, SCOPE_ADDRESS_BOOK)
    ]
