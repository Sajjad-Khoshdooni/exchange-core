...
def get_group_id_field(db_index: bool = False, null: bool = False, default=uuid4):
    return models.UUIDField(default=default, db_index=db_index, null=null, blank=null)
