    ...
    def update_trades(self, trade_pairs):
        ...
        for pair in trade_pairs:
            ...
            self.market_pipeline.publish(
                ...
                f'{taker_trade.id}#{maker_trade.price}#{maker_trade.amount}#{maker_trade.order.client_order_id or maker_trade.order_id}#{taker_trade.order.client_order_id or taker_trade.order_id}#{is_buyer_maker}'
            )
